...
def crear_pagina():
    ...
    <body>
        ...
        <h1>¡Hola desde el script Python de DevOps SERVIDOR WEB LINUX 3 NOMBRE CLAVE: DESPIERTE SEÑOR ALEX, MIRE QUE YA AMACENIO, UPAAAA UPAAAAA SEÑOR ALEEEEEX, DESPIERTAAAA!</h1>
